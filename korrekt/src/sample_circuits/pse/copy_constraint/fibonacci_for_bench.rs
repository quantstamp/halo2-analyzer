...
#[derive(Debug, Clone)]
struct FibonacciChip<F: Field, const SIZE: usize> {
...
#[derive(Default)]
pub struct FibonacciCircuit<F: Field, const SIZE: usize>(pub PhantomData<F>);

impl<F: Field, const SIZE: usize> Circuit<F> for FibonacciCircuit<F, SIZE> {
