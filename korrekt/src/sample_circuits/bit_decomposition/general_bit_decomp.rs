...
// pub struct BitDecompositon<F: PrimeField, const COUNT: usize> {
//     b: [F; COUNT],
// }
...
// impl<F: PrimeField, const COUNT: usize> Default for BitDecompositon<F, COUNT> {
//     fn default() -> Self {
//         BitDecompositon {
//             b: [F::from(1 as u64); COUNT],
//         }
//     }
// }

// impl<F: PrimeField, const COUNT: usize> Circuit<F> for BitDecompositon<F, COUNT> {
...
// pub struct BitDecompositonUnderConstrained<F: PrimeField, const COUNT: usize> {
//     b: [F; COUNT],
// }
...
// impl<F: PrimeField, const COUNT: usize> Default for BitDecompositonUnderConstrained<F, COUNT> {
//     fn default() -> Self {
...
// impl<F: PrimeField, const COUNT: usize> Circuit<F> for BitDecompositonUnderConstrained<F, COUNT> {
